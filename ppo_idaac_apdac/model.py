...
from ppo_idaac_apdac.utils import init
from ppo_idaac_apdac.distributions import Categorical
...
class ResNetBaseWithAttn(NNBase):
    """
    Residual Network
    """
    def __init__(self, num_inputs, hidden_size=256, channels=[16,32,32]):
        super(ResNetBaseWithAttn, self).__init__(hidden_size)
